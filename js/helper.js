...
var HTMLskills = '<li id="%data%" class="flex-item skills-li cursor-hand %data%"><span class="white-text">%data%</span></li>';
...
/*both below return same location
TODO: learn which is better practice and why*/
